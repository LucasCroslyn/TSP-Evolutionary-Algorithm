...
all_coordinates = read_coordinates("Sample Cities (Size 15 Coordinates).txt", NUMBER_OF_CITIES)
draw_graph(population[0], all_coordinates)
...
draw_graph(population[5], all_coordinates)
