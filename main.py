...
do_graph = True
RUN_THROUGH_AMOUNT = 10
NUMBER_OF_CITIES = 194  # Need to manually set the number of cities
GEN_SIZE = 200
SELECTION_SIZE = 31
MUT_CHANCE = 70
CROSS_CHANCE = 20
MUT_TYPE = 0    # 0 for swap, 1 for shuffle
ADDITIONAL_POP = True  # False for no chance of additional population through generations, True for the chance.
...
for runthrough in range(RUN_THROUGH_AMOUNT):
    POP_SIZE = 101  # Here in case the additional population parameter is turned on
